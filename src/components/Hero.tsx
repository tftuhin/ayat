        ...
        <div className="hero-grid">
          <div>
            <div className="glass inline-flex items-center gap-3 px-4 py-2 mb-6 reveal">
              <span className="w-2 h-2 rounded-full bg-peach-deep shadow-lg" />
            ...
            <h1 className="font-display text-5xl md:text-7xl font-normal leading-tight mb-6 reveal delay-1">
              ...
              <br />
              <span className="font-hand text-3xl md:text-4xl text-lavender-deep inline-block -rotate-1 mt-2 align-bottom">
            ...
            <div className="flex flex-wrap gap-2 mb-8 reveal delay-3">
              {["🎤 Recitation", "📖 Storytelling", "💃 Dance", "🎭 Stage"].map((tag) => (
                <span
                  key={tag}
                  className="glass px-4 py-2 text-sm font-semibold rounded-full bg-gradient-to-br from-peach/30 via-lavender/30 to-gold/30 border border-white/50"
                >
                  {tag}
                </span>
              ))}
            ...
            <div className="flex flex-wrap gap-3 mb-12 reveal delay-4">
              ...
              <a
                href="#awards"
                className="glass px-6 py-3 text-ink font-semibold rounded-full hover:translate-y-[-2px] transition-transform"
              >
                View awards
              </a>
            </div>
            ...
            <div className="flex gap-8 reveal delay-4">
              {[
                ...
                <div key={stat.label}>
                  ...
                  <div className="text-xs font-semibold uppercase tracking-widest text-ink-soft mt-1">
                    {stat.label}
                  </div>
                </div>
              ))}
