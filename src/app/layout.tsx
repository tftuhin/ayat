    ...
    <html lang="en">
      <body className="bg-[#fbf6ef] text-[#3a2a1f] overflow-x-hidden">
        <div className="fixed inset-0 -z-20 pointer-events-none" style={{
          background: "radial-gradient(60% 50% at 15% 10%, rgba(212, 163, 115, 0.35) 0%, transparent 60%), radial-gradient(50% 60% at 85% 20%, rgba(201, 197, 224, 0.25) 0%, transparent 65%), radial-gradient(70% 55% at 70% 90%, rgba(193, 212, 168, 0.25) 0%, transparent 60%), radial-gradient(50% 40% at 20% 80%, rgba(212, 179, 118, 0.2) 0%, transparent 65%)"
        }} />
        <div className="fixed inset-0 -z-10 pointer-events-none opacity-25" style={{
